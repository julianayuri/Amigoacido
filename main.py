...
class Fabrica(Popup):
    aminoacido = {"UUC": "fen", "UUU": "fen", "UUA": "leu", "UUG": "leu", "CUU": "leu", "CUC": "leu", "CUA": "leu",
                  "CUG": "leu", "AUU": "ile", "AUC": "ile", "AUA": "ile", "AUG": "met", "GUU": "val", "GUC": "val",
                  "GUA": "val", "GUG": "val", "UCU": "ser", "UCC": "ser", "UCA": "ser", "UCG": "ser", "AGU": "ser",
                  "AGC": "ser", "CCU": "pro", "CCC": "pro", "CCA": "pro", "CCG": "pro", "ACU": "tre", "ACC": "tre",
                  "ACA": "tre", "ACG": "tre", "GCU": "ala", "GCC": "ala", "GCA": "ala", "GCG": "ala", "UAU": "tir",
                  "UAC": "tir", "UAA": "stop", "UAG": "stop", "UGA": "stop", "CAU": "his", "CAC": "his", "CAA": "gln",
                  "CAG": "gln", "AAU": "asn", "AAC": "asn", "AAA": "lis", "AAG": "lis", "GAU": "asp", "GAC": "asp",
                  "GAA": "glu", "GAG": "glu", "UGU": "cis", "UGC": "cis", "UGG": "trp", "CGU": "arg", "CGC": "arg",
                  "CGA": "arg", "CGG": "arg", "AGA": "arg", "AGG": "arg", "GGU": "gli", "GGC": "gli", "GGA": "gli",
                  "GGG": "gli", }

    @staticmethod
    def define_color(letra):
        colors = {"A": [1, .4784313725490196, .4198078431372449, 1], "G": [1, .7294117647058824, .0088888888888889, 1],
                  "C": [.7882352941176471, .8745098039215686, .3490196078431373, 1],
                  "U": [.5098039215686275, .7411764705882353, 1, 1]}

        color = colors.get(letra)
    ...
    def conferir_resposta(self):
        ...
        if dic_nucleotideos[self.ids.p.text] == resp_p and dic_nucleotideos[self.ids.s.text] == resp_s and dic_nucleotideos[self.ids.t.text] == resp_t:
            ...
            aminoacido = self.aminoacido.get(codon)
            ...
            if aminoacido == 'stop':
                ...
                if self.aminoacidos.get(aminoacido)['status'] == 0:
                    App.get_running_app().root.children[0].children[3].children[
                        self.dic_aa[aminoacido]].img_src = "Image/Monstros/" + aminoacido + ".png"
                ...
                self.aminoacidos.put(aminoacido, name=name_, status=1, qtd=qtd_aa,
                                     moedas=self.aminoacidos.get(aminoacido)['moedas'],
                                     price=self.aminoacidos.get(aminoacido)['price'])
    ...
    def __init__(self, **kwargs):
        ...
        self.dic_aa = {"val": 19, "leu": 18, "trp": 17, "pro": 16, "ile": 15, "met": 14, "fen": 13, "ala": 12,
                       "tre": 11, "gli": 10, "asn": 9, "gln": 8, "cis": 7, "ser": 6, "tir": 5, "arg": 4, "his": 3,
                       "lis": 2, "glu": 1, "asp": 0}
...
class Item(GridLayout):
    ...
    def upgrade_aminoacido(self, aminoacido):
        ...
        if moedas >= price_:
            ...
            self.ids.item_button.text = str(price_ * 2) + ' UP' #' UPGRADE'
    ...
    def buy_codon(self):
        ...
        if moedas >= preco:
            ...
            self.ids.item_button.text = str(preco) + ' BUY'
        else:
            self.pops_nao_possui.info_src = "Image/nao_possui.png"
            self.pops_nao_possui.open()
...
class Loja(Popup):
    ...
    def load_loja(self):
        ...
        aa = ["val", "leu", "trp", "pro", "ile", "met", "fen", "ala", "tre", "gli", "asn", "gln", "cis", "ser", "tir",
              "arg", "his", "lis", "glu", "asp"]
        ...
        desc = name + '\n' + str(qtd) + ' Exemplares\n'
        button_text = str(price) + ' BUY'
        self.ids['loja'].add_widget(
            Item(text=desc, image_path=path, value=price, button_txt=button_text, referencia='codon'))
        ...
        for a in aa:
            if aminoacidos.get(a)['status'] == 1:
                ...
                button_text = str(price) + ' UP'
                self.ids['loja'].add_widget(
                    Item(text=desc, image_path=path, value=price, button_txt=button_text, referencia=a))
...
class Tutorial(Popup):
    ...
    def change(self):
        change_flow = {
            'Image/Tutorial/01.png': 'Image/Tutorial/02.png',
            'Image/Tutorial/02.png': 'Image/Tutorial/03.png',
            'Image/Tutorial/03.png': 'Image/Tutorial/04.png',
            'Image/Tutorial/04.png': 'Image/Tutorial/05.png',
            'Image/Tutorial/05.png': 'Image/Tutorial/06.png',
            'Image/Tutorial/06.png': 'Image/Tutorial/07.png',
            'Image/Tutorial/07.png': 'Image/Tutorial/08.png',
            'Image/Tutorial/08.png': 'Image/Tutorial/09.png',
            'Image/Tutorial/09.png': 'Image/Tutorial/10.png',
            'Image/Tutorial/10.png': 'Image/Tutorial/11.png',
            'Image/Tutorial/11.png': 'Image/Tutorial/12.png',
            'Image/Tutorial/12.png': 'Image/Tutorial/13.png',
        }
        back = change_flow.get(self.back)
